...
public class ObjectPool : MonoBehaviour
{
    ...
    {
        /// <summary>
        /// The name of the entry, just for aesthetic purposes
        /// </summary>
        [SerializeField]
        public string name;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < Entries.Length; i++)
        {
            ...
            {
                // Default instantiated object to inactive to prevent events from triggering
                //objectPrefab.Prefab.SetActive(false);
